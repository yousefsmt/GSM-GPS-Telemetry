...
#define taskSIM800_STARTUP_STACK_SIZE      ( 128 )
#define taskSIM800_STARTUP_STACK_PRIORITY  (configMAX_PRIORITIES - 1 )

#define taskSIM800_SENDER_STACK_SIZE      ( 128 )
#define taskSIM800_SENDER_STACK_PRIORITY  (configMAX_PRIORITIES - 1 )
